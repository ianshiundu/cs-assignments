...
Officer: 5503153
CaseNum: 303-0-85203383-5503153
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make ClassifiedBoxValue_A equal to 36

	When any key is pressed:
	- Make ClassifiedBoxValue_A equal to 30

	When the mouse button is released:
	- Make ClassifiedBoxValue_A equal to 12

	Whilst the mouse is moving:
	- Make ClassifiedBoxValue_A equal to 6

	When any key is released:
	- Make ClassifiedBoxValue_B equal to 62

	Whilst the mouse is being dragged:
	- Make ClassifiedBoxValue_B equal to 74

	Whilst the mouse is moving:
	- Make ClassifiedBoxValue_B equal to 76

	When the mouse button is released:
	- Make ClassifiedBoxValue_B equal to 48
...
//    	Whilst the mouse is moving:
//	- Make ClassifiedBoxValue_A equal to 6
    ClassifiedBoxValue_A = 6;
//	Whilst the mouse is moving:
//	- Make ClassifiedBoxValue_B equal to 76
    ClassifiedBoxValue_B = 76;
}
...
//	When the mouse button is released:
//	- Make ClassifiedBoxValue_A equal to 12
    ClassifiedBoxValue_A = 12;
//    	When the mouse button is released:
//	- Make ClassifiedBoxValue_B equal to 48
    ClassifiedBoxValue_B = 48;
}
...
function draw()
{
	...
	drawDial(200, ClassifiedBoxValue_A, 39);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(ClassifiedBoxValue_B);
	pop();
